      ...
      <div className="container mx-auto px-4 py-3 md:py-4">
        <div className="flex items-center justify-between">
          ...
          <Link href="/" className="flex items-center gap-2">
            ...
            />
            <span className="text-lg md:text-xl font-bold text-gray-900">Eboni Dating</span>
          </Link>
          ...
          <nav className="hidden md:flex items-center gap-4">
            <DropdownMenu>
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                <DropdownMenuItem asChild>
                  <Link href="/advertise" className="w-full cursor-pointer">
                    <svg className="w-4 h-4 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
            ...
            <Sheet open={isOpen} onOpenChange={setIsOpen}>
              ...
              <SheetContent side="right" className="w-[280px] sm:w-[320px]">
                ...
                <nav className="flex flex-col gap-4 mt-6">
                  <Link 
                    href="/pricing" 
                    className="flex items-center gap-3 text-base hover:text-amber-600 transition-colors py-2"
